-- PrintDesk simple bootstrap for Supabase SQL Editor.
-- Use this if the full migration paste fails.
...
create table if not exists public.print_jobs (
  ...
  constraint print_jobs_duplex_mode_check check (duplex_mode in ('one_sided', 'two_sided_long_edge', 'two_sided_short_edge')),
